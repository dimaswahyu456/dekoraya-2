...
<div class="row">
    <div class="col-lg-12">
        <div class="row">
            ...
            $jumlah_record = mysqli_query($mysqli, "SELECT * FROM is_portfolio")
            ...
            $query = mysqli_query($mysqli, "SELECT * FROM is_portfolio ORDER BY portfolio_id DESC LIMIT $mulai, $batas")
